...
currencyIn.set(currRev, { x: -30, opacity: 0 })
          ...
          .set([".menu__btn", ".menu-close__btn"], { pointerEvents: "none" }, "<")
          .fromTo(currBg, { scale: 1 }, { scale: 40, transformOrigin: "50% 50%", ease: Expo.easeInOut, duration: 1.2})
          .set(".touch-print-open__wrap", {autoAlpha: 0}, "-=0.78")
          .set(".touch-print-close__wrap", {filter: "invert(1)", autoAlpha: 1}, "<")
          .to(".nav__logo-btn", { autoAlpha: 0, duration: 0.01 }, "-=0.73")
...
currencySelect.forEach((currencySelect) => {
    ...
    gsap.set(currencyHole, { borderTopWidth:1240, borderRightWidth:1240, borderBottomWidth:1240, borderLeftWidth:1240, borderRadius: "50%", display: "none", rotation: 0})
 ...
 currSelectOut
        ...
        .set(".cursor-dot", { display: "flex", scale: 0, autoAlpha: 0 }, "<")
        ...
        .fromTo(currencyHole, { borderTopWidth:1240, borderRightWidth:1240, borderBottomWidth:1240, borderLeftWidth:1240, borderRadius: "50%", rotation: 0 }, { duration: 1.2, borderTopWidth:40, borderRightWidth:40, borderBottomWidth:40, borderLeftWidth:40, borderRadius: "50%", rotation:0.01, ease: Power1.easeOut }, "-=0.3")    
        ...
        .to(".currency-exit-txt", { autoAlpha: 0, duration: 0.001 }, "<")
        .to(".currencies-list__contain", { autoAlpha: 1, duration: 0.001 }, "<")
        .set(".menu-txt", { filter: 'invert(0%)' }, "-=0.05")
        ...
        .set(currencyHole, {display: "none", borderTopWidth:1240, borderRightWidth:1240, borderBottomWidth:1240, borderLeftWidth:1240, borderRadius: "50%", rotation: 0 })
        .set(currRev, { x: -20, opacity: 0 })
        .set(navBotRev, { x: -10, opacity: 0 })
        .set(".nav-bot-rev-vert", { y: 5, opacity: 0 })
        .set(".currency-exit-txt", { color: '#ffffff'})
