...
currencySelect.forEach((currencySelect) => {
    ...
    const currencyHole = document.querySelector(['.currency-hole', '.currency-hole-mobile'])
 ...
 currSelectOut
        ...
        //.fromTo('.currency-hole-mobile', { scale: 1 }, { duration: 1.2, scale: 280, ease: "expoScale(1, 280, power1.easeOut)" }, "-=1.5")
