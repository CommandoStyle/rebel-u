...
currencySelect.forEach((currencySelect) => {
    ...
    gsap.set(currencyHole, { borderTopWidth:990, borderRightWidth:990, borderBottomWidth:990, borderLeftWidth:990, borderRadius: "50%", display: "none", rotation: 0})
 ...
 currSelectOut
        ...
        .fromTo(currencyHole, { borderTopWidth:990, borderRightWidth:990, borderBottomWidth:990, borderLeftWidth:990, borderRadius: "50%", rotation: 0 }, { duration: 1.2, borderTopWidth:40, borderRightWidth:40, borderBottomWidth:40, borderLeftWidth:40, borderRadius: "50%", rotation:0.01, ease: Power1.easeOut }, "-=0.3")    
        ...
        .set(currencyHole, {display: "none", borderTopWidth:990, borderRightWidth:990, borderBottomWidth:990, borderLeftWidth:990, borderRadius: "50%", rotation: 0 })
        .set(currRev, { x: -20, opacity: 0 })
        .set(navBotRev, { x: -10, opacity: 0 })
        .set(".nav-bot-rev-vert", { y: 5, opacity: 0 })
        .set(".currency-exit-txt", { color: '#ffffff'})
