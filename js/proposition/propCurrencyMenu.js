...
if (isSafari) {
 ...
 currSelectOut
        ...
        .to(navBotRev, { x: 30, opacity: 0, ease: "expo.out", duration: 0.3 },"-=0.65")
        .to(".nav-bot-rev-vert", { y: -15, opacity: 0, ease: "expo.out", duration: 0.3 },"<") 
        .fromTo(currencyHole, { borderTopWidth:"99.9vw", borderRightWidth:"99.9vw", borderBottomWidth:"99.9vw", borderLeftWidth:"99.9vw", borderRadius: "50%", rotation: 0 }, { duration: 1.5, borderTopWidth:"2.9vw", borderRightWidth:"2.9vw", borderBottomWidth:"2.9vw", borderLeftWidth:"2.9vw", borderRadius: "50%", rotation:0.01, ease: Power1.easeOut }, "-=0.3")    
        .to('[data-img]', { autoAlpha: 0, duration: 0.3, ease: "sine.inOut" },"-=1.8")
        .to(".home-nav__btn", { autoAlpha: 0, duration: 0.001 }, "-=1.15")
        .to(".nav__logo-btn", { autoAlpha: 1, duration: 0.001 }, "<")
        .to(".currency-exit-txt", { color: '#000000', duration: 0.001}, "<")
        .to(".currencies-list__contain", { filter: 'invert(0%)', duration: 0.001}, "<")
        .to(".currency-exit-txt", { autoAlpha: 0, duration: 0.001 }, "<")
        .to(".currencies-list__contain", { autoAlpha: 1, duration: 0.001 }, "<")
        .set(".menu-txt", { filter: 'invert(0%)' }, "-=1.15")
