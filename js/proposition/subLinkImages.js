export const subLinkImages = () => {
      ...
      class subsLink {
        ...
        constructor(el) {
          ...
          this.DOM.subsItems = this.DOM.el.querySelectorAll('.sub-hero__h-contain');
      ...
      class SubsItem {
        ...
        layout() {
                ...
                this.DOM.reveal.className = 'prop-hover-reveal';
                this.DOM.reveal.style.transformOrigin = "0% 0%";
                this.DOM.revealInner = document.createElement('div');
                this.DOM.revealInner.className = 'prop-hover-reveal__inner';
                this.DOM.revealImage = document.createElement('div');
                this.DOM.revealImage.className = 'prop-hover-reveal__img';
        ...
        showImage() {
          ...
          this.tl = gsap.timeline({
            onStart: () => {
              ...
              gsap.set(this.DOM.revealInner, {scale: 0.8, xPercent: 2.5});
            }
          })
      ...
      const subsEl = document.querySelector('.sub-hero__items');
      
      const imagesEl = document.querySelectorAll('.sub-hero__h-contain');
      let imagesArr = [];
      imagesEl.forEach(image => {
        imagesArr.push(image.dataset.image);
      });
