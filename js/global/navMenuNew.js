...
var navIn = new gsap.timeline({ paused: true });
     ...
     navIn
          ...
          .set(navBg, {scale: 0.025, autoAlpha: 1, display: "block"})
          ...
          .fromTo(navBg, { scale: 0.025 }, { scale: 1, transformOrigin: "50% 50%", ease: "expoScale(0.025, 1)", duration: 1 })
    ...
    navClose.forEach(navClose => {
     ...
     navOut.set(navClose, {display: "none"})
           ...
           .fromTo(navBg, { scale:1 }, {scale: 0.015, ease: Expo.easeOut, duration: 1.1 })
