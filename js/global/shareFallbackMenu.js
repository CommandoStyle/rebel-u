...
shareIn.set(shareRev, { x: -30, opacity: 0 })
          ...
          .set([".redact-cover-share", ".redact-cover-contact", ".redact-cover-legal", ".redact-cover-top-left"], { scaleX: 0, backgroundColor: '#ffffff'})
          .set(".redact-cover-top-left", {display: "block"})         
          .set(shareBg, { autoAlpha: 1 })
          .set(".cursor-dot", {display: "none"}, "<")
          .set(shareOpen, {display: "none"}, "<")
          .set(shareExit, {display: "flex"}, "<")
          .set([".share-open-txt", ".contact-txt", ".legal-txt"], { filter: 'invert(100%)'}, "<")
