...
quizCancel.forEach((quizCancel) => {
  ...
  quiz_cancel
	 ...
	 .fromTo(navBg, { scale:40 }, {scale: 0.8333, ease: Expo.easeOut, duration: 1.1 }, "-=0.2")
	 .to(".redact-cover-quiz-exit", { scaleX: 1, transformOrigin: "0% 100%", duration: 0.129, ease: "linear"})
	 .to(".quiz-exit-txt", { autoAlpha: 0, duration: 0.001 })
	 .to(".menu__btn", { delay: 0, display: "flex", opacity: 1, duration: 0.001 }, "<")
	 .to(cursor, { delay: 0, scale: 0.5, autoAlpha: 1, duration: 0.001 }, "<")
