...
quizCancel.forEach((quizCancel) => {
  ...
  quiz_cancel
	 ...
	 .set(".touch-print-open__wrap", { autoAlpha: 1 })
         ...
         .fromTo(quizHoleMobile, { scale: 1 }, { duration: 1.2, scale: 280, ease: "expoScale(1, 280, power1.easeOut)" }, "-=0.2")
...
quizCancelSuccess.addEventListener("click", (e) => {
    ...
    quiz_cancel_success
	   ...
	   .fromTo(quizHoleMobile, { scale: 1 }, { duration: 1.2, scale: 280, ease: "expoScale(1, 280, power1.easeOut)", onComplete() { sessionStorage.setItem("quizSuccessPlayed", true) } }, "-=0.2")
           .to(cursor, { delay: 0.55, scale: 1, autoAlpha: 1, xPercent: -38, yPercent: -60, duration: 0.45 })
           .set(CategoryQuiz, { x: -30, yPercent: 0, display: "none" })
           .set(quizCancelinner, { x: -30, yPercent: 0 })
