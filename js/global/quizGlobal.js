...
quizCancel.forEach((quizCancel) => {
  ...
  quiz_cancel
	 ...
	 .to([".redact-cover-quiz-exit", ".redact-cover-nav"], { delay: 0.2, scaleX: 1, transformOrigin: "0% 100%", duration: 0.169, ease: "linear"}) 
	 ...
	 .to([".redact-cover-quiz-exit", ".redact-cover-nav"], { scaleX: 0, transformOrigin: "100% 0%", duration: 0.169, ease: "linear"}) 
