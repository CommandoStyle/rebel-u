        ...
        barba.init({
            ...
            // home
          {
            ...
            enter(data) {
              ...
              return gsap.fromTo(
                data.next.container,
                { clipPath: `circle(3% at ${percentLeft}% ${percentTop - 3}%)` },
                { clipPath: `circle(140.9% at ${percentLeft}% ${percentTop - 3}%)`, delay: 0.75, duration: 1.1, ease: "power2.inOut", clearProps: "clipPath",
                onComplete: () => {
