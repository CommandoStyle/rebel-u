...
readinessCircled.load(readinessCircdata);
    ...
    readyIntroOnce
	  ...
	  .to(".stamp-redact-cover", { delay: 0.6, scaleX: 1, transformOrigin: "0% 100%", duration: 0.4, ease: "linear"})
	  .to("#quizstampimg", { autoAlpha: 1, duration: 0.001})
	  .to(".stamp-redact-cover", { scaleX: 0, transformOrigin: "100% 0%", duration: 0.4, ease: "linear"})
