...
class subsLink {
  ...
  constructor(el) {
    ...
    this.DOM.subsItems = this.DOM.el.querySelectorAll('.is--alumni-hover');
  ...
  showImage() {
    ...
    this.tl = gsap.timeline({
      onStart: () => {
        ...
        gsap.set(this.DOM.revealInner, {scale: 0.8, xPercent: 3, yPercent: 3.5});
      }
    })
...
const subsEl = document.querySelector('.alumni__list');

const imagesEl = document.querySelectorAll('.is--alumni-hover');
let imagesArr = [];
