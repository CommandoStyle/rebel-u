...
var ssClickStop = document.querySelectorAll('.cta-btn, .menu__btn, .nav__logo-btn, .currency__btn, mrebel__submit-query, .quiz-cta__btn');
var ssClickStart = document.querySelectorAll('.currency-exit__btn, .menu-close__btn');
