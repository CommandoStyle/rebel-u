...
const legalIntroIframe = (container) => {
...
var legalIntroIframe = gsap.timeline();
      
legalIntroIframe

.to(".sub-hero__spacer-line", { delay: 1.1, duration: 1, scaleX: 1, transformOrigin: "0% 100%", ease: "power2.easeOut" })
...
export default legalIntroIframe;